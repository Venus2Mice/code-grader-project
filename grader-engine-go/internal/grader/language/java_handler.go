...
func (h *JavaHandler) Compile(ctx context.Context, cli *client.Client, containerID string, sourceCode string) (success bool, errorMsg string, err error) {
	...
	// Compile with javac (include Gson in classpath)
	compileCmd := []string{
		"javac",
		"-encoding", "UTF-8",
		"-cp", "/opt/gson/gson.jar:.", // Include Gson in classpath
...
func (h *JavaHandler) GetExecutableCommand() string {
	// LeetCode-style problems use "Solution" as the class name
	// This is generated by harness_java_v2.go
	return "java -cp /opt/gson/gson.jar:. Solution"
}
